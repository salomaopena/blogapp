...
| # | Aula | Assistir |
|:-:|------|:--------:|
| 01 | [![Aula 01](docs/thumbnails/aula-01.png)](https://youtu.be/3bQZHi6DhN4)<br>**Construí um sistema COMPLETO com CodeIgniter 4 + Shield (login, papéis, notificações) — e vou te ensinar do zero** | [▶ Assistir](https://youtu.be/3bQZHi6DhN4) |
| 02 | [![Aula 02](docs/thumbnails/aula-02.png)](https://youtu.be/woUf2xyvVLo)<br>**CodeIgniter 4 em 2026: instalação do zero com Composer (PHP 8.3)** | [▶ Assistir](https://youtu.be/woUf2xyvVLo) |
| 03 | [![Aula 03](docs/thumbnails/aula-03.png)](https://youtu.be/O4Jcs3jIcMY)<br>**Autenticação PRONTA no CodeIgniter 4 com Shield (login + registro em 1 comando)** | [▶ Assistir](https://youtu.be/O4Jcs3jIcMY) |
| 04 | [![Aula 04](docs/thumbnails/aula-04.png)](https://youtu.be/PHENas4igls)<br>**Papéis de usuário no Shield: admin, editor e member (AuthGroups na prática)** | [▶ Assistir](https://youtu.be/PHENas4igls) |
...
| 06 | [![Aula 06](docs/thumbnails/aula-06.png)](COLE_O_LINK_DA_AULA_06)<br>**Migrations no CodeIgniter 4: tabela posts com FOREIGN KEY para o Shield** | [▶ Assistir](COLE_O_LINK_DA_AULA_06) |
| 07 | [![Aula 07](docs/thumbnails/aula-07.png)](COLE_O_LINK_DA_AULA_07)<br>**Models no CodeIgniter 4: validação e soft delete SEM escrever SQL** | [▶ Assistir](COLE_O_LINK_DA_AULA_07) |
| 08 | [![Aula 08](docs/thumbnails/aula-08.png)](COLE_O_LINK_DA_AULA_08)<br>**Painel admin PROFISSIONAL no CodeIgniter 4: Bootstrap 5 + rotas protegidas com Shield** | [▶ Assistir](COLE_O_LINK_DA_AULA_08) |
| 09 | [![Aula 09](docs/thumbnails/aula-09.png)](COLE_O_LINK_DA_AULA_09)<br>**CRUD no CodeIgniter 4 + Shield: criar posts com CSRF e autor automático** | [▶ Assistir](COLE_O_LINK_DA_AULA_09) |
| 10 | [![Aula 10](docs/thumbnails/aula-10.png)](COLE_O_LINK_DA_AULA_10)<br>**NUNCA exponha IDs na URL: criptografia nativa no CodeIgniter 4** | [▶ Assistir](COLE_O_LINK_DA_AULA_10) |
| 11 | [![Aula 11](docs/thumbnails/aula-11.png)](COLE_O_LINK_DA_AULA_11)<br>**Página pública com URL cifrada no CI4 (e o erro que TODO iniciante comete)** | [▶ Assistir](COLE_O_LINK_DA_AULA_11) |
| 12 | [![Aula 12](docs/thumbnails/aula-12.png)](COLE_O_LINK_DA_AULA_12)<br>**Permissões por rota no Shield: filtro permission + can() no menu** | [▶ Assistir](COLE_O_LINK_DA_AULA_12) |
| 13 | [![Aula 13](docs/thumbnails/aula-13.png)](COLE_O_LINK_DA_AULA_13)<br>**Tela de gestão de usuários no Shield: trocar papéis com syncGroups()** | [▶ Assistir](COLE_O_LINK_DA_AULA_13) |
| 14 | [![Aula 14](docs/thumbnails/aula-14.png)](COLE_O_LINK_DA_AULA_14)<br>**Sistema de notificações internas no CodeIgniter 4 (com badge no menu)** | [▶ Assistir](COLE_O_LINK_DA_AULA_14) |
| 15 | [![Aula 15](docs/thumbnails/aula-15.png)](COLE_O_LINK_DA_AULA_15)<br>**Events + Email Library no CodeIgniter 4: e-mail automático quando algo acontece** | [▶ Assistir](COLE_O_LINK_DA_AULA_15) |
| 16 | [![Aula 16](docs/thumbnails/aula-16.png)](COLE_O_LINK_DA_AULA_16)<br>**Checklist FINAL: CodeIgniter 4 + Shield pronto para produção** | [▶ Assistir](COLE_O_LINK_DA_AULA_16) |
